...
complete -c nmap -l data-length --description '.'
...
complete -c nmap -l 'packet-trace.' --description 'OS DETECTION One of Nmaps best-known features i… [See Man Page]'
...
complete -c nmap -l datadir --description '$NMAPDIR.  ~/. nmap (not searched on Windows).'
