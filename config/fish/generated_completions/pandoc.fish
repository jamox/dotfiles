# pandoc
# Autogenerated from man page /usr/local/share/man/man1/pandoc.1.gz
...
complete -c pandoc -s V --description '.'
complete -c pandoc -l variable --description 'Set the template variable KEY to the value VAL … [See Man Page]'
complete -c pandoc -s D --description '.'
complete -c pandoc -l print-default-template --description 'Print the default template for an output FORMAT.'
...
complete -c pandoc -s H --description '.'
complete -c pandoc -l include-in-header --description 'Include contents of FILE, verbatim, at the end of the header.'
complete -c pandoc -s B --description '.'
complete -c pandoc -l include-before-body --description 'Include contents of FILE, verbatim, at the begi… [See Man Page]'
complete -c pandoc -s A --description '.'
complete -c pandoc -l include-after-body --description 'Include contents of FILE, verbatim, at the end … [See Man Page]'
...
complete -c pandoc -s T --description '.'
complete -c pandoc -l title-prefix --description 'Specify STRING as a prefix at the beginning of … [See Man Page]'
...
complete -c pandoc -l bibliography --description 'Specify bibliography database to be used in res… [See Man Page]'
complete -c pandoc -l csl --description 'Specify CSL style to be used in formatting cita… [See Man Page]'
complete -c pandoc -l citation-abbreviations --description 'Specify a file containing abbreviations for jou… [See Man Page]'
...
complete -c pandoc -o V/--variable --description 'This allows users to include custom variables i… [See Man Page]'
complete -c pandoc -l ---------------- --description '.'
complete -c pandoc -o s/--standalone --description 'files, which are assumed to be available at the… [See Man Page]'
