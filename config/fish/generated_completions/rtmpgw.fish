# rtmpgw
# Autogenerated from man page /usr/local/share/man/man8/rtmpgw.8
...
complete -c rtmpgw -l 'jtv		-jJSON' --description 'JSON token used by legacy Justin. tv servers.'
...
complete -c rtmpgw -l 'jtv		-j' --description 'JSON token used by legacy Justin. tv servers.'
