...
complete -c links -o aggressive-cache --description 'Always cache everything regardless of server\'s … [See Man Page]'
complete -c links -o address-preference --description '(default 0) 0 - use system default.  1 - prefer IPv4.'
...
complete -c links -o https-proxy --description 'Host and port number of the HTTPS proxy, or blank.'
complete -c links -o socks-proxy --description 'Userid, host and port of Socks4a, or blank.  (default: blank).'
complete -c links -o append-text-to-dns-lookups --description 'Append text to dns lookups.'
...
complete -c links -o overwrite-instead-of-scroll --description 'Overwrite the screen instead of scrolling it (v… [See Man Page]'
