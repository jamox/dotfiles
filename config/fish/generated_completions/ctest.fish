# ctest
# Autogenerated from man page /usr/local/share/man/man1/ctest.1
...
complete -c ctest -l build-config-sample --description 'A sample executable to use to determine the configuration .'
...
complete -c ctest -l submit-index --description 'Legacy option for old Dart2 dashboard server feature.'
...
complete -c ctest -l 'build-and-test.' --description 'run after the build is complete.'
