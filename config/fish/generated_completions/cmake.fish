# cmake
# Autogenerated from man page /usr/local/share/man/man1/cmake.1
...
complete -c cmake -s T --description 'Specify toolset name if supported by generator.'
...
complete -c cmake -l graphviz --description 'Generate graphviz of dependencies, see CMakeGraphVizOptions.'
...
complete -c cmake -l target --description '.'
complete -c cmake -l config --description '.'
complete -c cmake -l clean-first --description '                 (To clean only, use --target \'clean\'. ).'
complete -c cmake -l use-stderr --description '.'
